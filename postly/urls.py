...
from users.views import UserProfileView, FollowsListView, FollowersListView
...
urlpatterns = [
    ...
    path('popular-authors/', user_views.popular_authors, name='popular-authors'),
    path('edit-profile/', user_views.EditProfile, name='edit-profile'),
    path('<str:username>/following/', FollowsListView.as_view(), name='following'),
